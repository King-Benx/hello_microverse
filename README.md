...
This project addresses tests my knowledge on html, css and linters as well as Github actions that also handle linting.

**[Hello Microverse]** is a simple project demonstrating linters.
...
```git clone git@github.com:King-Benx/hello_microverse.git```
